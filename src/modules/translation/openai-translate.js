...
async function startreviewOpenAI(apikeyOpenAI,destlang,OpenAIPrompt,reviewPrompt) {
    ...
    var result;
    var countreplaced = 0;
    var checkButton = document.querySelector(".wppoNavBarCont a.check_translation-button");
    var progressbar;
    ...
    for (let e of document.querySelectorAll("tr.editor div.editor-panel__left div.panel-content")) {
        ...
        if (countrows == tableRecords) {
            ...
            checkButton = document.querySelector(".wppoNavBarCont a.check_translation-button");
