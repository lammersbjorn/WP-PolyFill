function scrapeconsistency(locale, org_verb, wrong_verb) {
    ...
    currWindow.document.getElementById("wppo_head").appendChild(a);
    currWindow.document.getElementById("wppo_head").innerHTML +=
                        ...
                        .then(function (html) {
                            ...
                            if (typeof mytable != "undefined") {
                                ...
                                if (replCount != 0) {
                                    ...
                                    wppo_download("[" + current_date.toLocaleString([], { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" }) + " wppo replace log.txt]", replace_links, currWindow);
                                }
                                consistsWindow.close();
                            }
                            else {
...
function wppo_download(filename, text, myWindow) {
